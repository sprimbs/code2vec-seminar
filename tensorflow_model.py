...
class Code2VecModel(Code2VecModelBase):
    ...
    def initialize_finetuning(self):
        self.log('Initializing fine tuning.')
        ...
        _, _ = self._build_tf_training_graph(input_tensors, trainable=False)
    ...
    def _build_tf_training_graph(self, input_tensors, trainable=True):
        ...
        optimizer = tf.compat.v1.train.AdamOptimizer().minimize(loss) if trainable else None
